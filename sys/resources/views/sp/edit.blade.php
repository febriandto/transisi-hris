	...
	<div class="container">
		<div class="main_area">	
			...
			<div class="content">
				...
				{{ csrf_field() }}
				<input type="hidden" name="no_sp" value="{{ $sp->no_sp }}">

				<table id="add_new" class="cell-border" cellspacing="0" width="100%">
					<tr>
			        	<td>
				        	<label> Employee </label><br>
				        	<input style="padding: 4px 4px 5px 4px; font-size: 13px; color: grey;" type="text" name="id_emp" id="a" placeholder="Choose Employee" value="{{ $sp->id_emp }}">
			        ...
			        <tr>
			        	...
			        	<input type="text" value="{{ $sp->no_sp }}" class="form-control" id="no_radius" placeholder="SP Number" disabled="disabled">
			        	</td>
			        </tr>
			        ...
			        <tr>
			        	...
			        	<input type="date" name="sp_date" value="{{ $sp->sp_date }}" class="form-control" id="no_radius" placeholder="SP Date Sign">
			        	</td>
			        </tr>
			        <tr>
			        	<td>
			        	...
			        	<select name="id_spcat" class="form-control" id="no_radius">
			        		...
			        		<option {{ $data->id_spcat == $sp->id_spcat ? 'selected' : '' }} value="<?php echo $data->id_spcat;?>"><?php echo $data->spcat_name;?></option>
			        		@endforeach
			        	</select>
			        	</td>
			        </tr>
			        <tr>
			        	...
			        	<input type="text" name="sp_title" value="{{ $sp->sp_title }}" class="form-control" id="no_radius" placeholder="SP Title">
			        	</td>
			        </tr>
			        <tr>
			        	<td>
			        	<label> SP Description Case </label><br>
			        	<textarea name="sp_description" rows="10" class="form-control" id="no_radius" placeholder="SP Detail Description">{{ $sp->sp_description }}</textarea>
			        	</td>
			        </tr>
			        <tr>
			        	<td>&nbsp;</td>
			        ...
			        <tr>
			        	...
			        	<textarea name="sp_punishment" rows="10" class="form-control" id="no_radius" placeholder="SP Detail Punishment">{{$sp->sp_punishment}}</textarea>
			        	</td>
			        </tr>
			        <tr>
			        	<td>&nbsp;</td>
			        ...
			        <tr>
			        	...
			        	<input type="date" name="sp_valid_date" value="{{ $sp->sp_valid_date }}" class="form-control" id="no_radius" placeholder="SP Valid Until">
			        	</td>
			        </tr>    
