...
<div class="row">
	<div class="col-md-6">
		<div class="card">
			<div class="card-body">
				<form role="form" method="POST" action="{{ route('tally.save_item') }}">
					{{ csrf_field() }}

					<input type="hidden" name="tally_no" value="{{ $tally->tally_no }}">

					<label for="item_number" class="d-block">Item Number</label>
					<input type="text" name="item_number" id="item_number" class="form-control form-control-sm" placeholder="Choose Item" style="width: 80%;display: inline-block;">
					...
					<input type="number" name="tally_qty" class="form-control form-control-sm" placeholder="Qty">
