		...
		<div class="main_area">
			...
			<div class="content">
				...
				<div class="top_menu_list">
					<a class="btn {{ \Request::route()->getName() == 'employee.index' ? 'btn-primary' : 'btn-default' }} btn-sm" id="no_radius" href="{{ route('employee.index') }}">Karyawan Aktif ({{$ActiveEmployee}})</a>
					<a class="btn {{ \Request::route()->getName() == 'employee.resign' ? 'btn-primary' : 'btn-default' }} btn-sm" id="no_radius" href="{{ route('employee.resign') }}"> Resign ({{$ResignEmployee}})</a>
					<span style="float:right;">
						<a class="btn btn-sm btn-warning" id="no_radius" href="{{ route('emp_list.index') }}"> <i class="fa fa-bars icon_left" title="See another ways"></i> Tampilan Grid </a>
						...
						<a href="{{ route('employee.export') }}" target="_blank" class="btn btn-primary flat btn-sm" id="no_radius">
				...
				<hr>
				@if( \Request::route()->getName() != 'employee.resign' )
