...
<div class="bg_area">&nbsp;</div>
	...
	<div class="container">
		<div class="main_area">	
			...
			<div class="col-md-8">
			<div class="content">
				<h4><b>Employee Accident Input Form</b></h4>
				<hr>
				<!-- <table id="tabel_howto" width="100%"> -->
				<form action="{{  route('accident.save') }}" method="post" enctype="multipart/form-data">
				{{ csrf_field() }}
				<table id="add_new" class="cell-border" cellspacing="" width="100%">
					<tr>
			        	<td>
				        	<label> Accident Code </label><br>
				        	<input type="text" name="id_accident" class="form-control" id="no_radius" required="" placeholder="Accident Code">
			        	</td>
			        	<td>&nbsp;</td>
			        	<td>
				        	...
				        	<select name="id_emp" class="form-control" id="no_radius" required="">
				        		...
				        		@foreach( $employee as $emp )
	                            	<option value="{{ $emp->id_emp }}"> {{ $emp->id_emp }} -- {{ $emp->emp_name }}</option>
				        		@endforeach
				        	</select>
			        	</td>
			        </tr>
			        	...
			        	<td>
				        	...
				        	<select name="id_acc_cat" class="form-control" id="no_radius" required="">
				        		...
				        		@foreach( $accident_category as $cat )
                                	<option value="{{$cat->id_acc_cat}}"> {{$cat->acc_catname}} </option>
				        		@endforeach
				        	</select>
			        	</td>
			        	<td></td>
			        ...
			        <tr>
			        	<td>
				        	...
				        	<input type="time" name="acc_time" class="form-control" id="no_radius" required="">
			        	</td>
			       		<td></td>
			        	<td>
				        	<label> Date of the Incident </label><br>
				        	<input type="date" name="acc_date" class="form-control" id="no_radius">
			        	</td>
			        </tr>
			    </table>&nbsp;
			    <table id="add_new" class="cell-border" cellspacing="" width="100%">
			    	<tr>
			        	<td>
				        	...
				        	<textarea name="acc_desc" class="form-control" id="no_radius"></textarea>
			        	</td>
			        </tr>
			        <tr>
			        	<td>
				        	<label><br> Recovery Description </label><br>
				        	<textarea name="acc_recovery_desc" class="form-control" id="no_radius"></textarea>
			        	</td>
			        </tr>
			        <tr>
			        	<td>
